...
import { useCreateLesson } from '../../hooks/teacherHooks';
import { useQueryClient } from '@tanstack/react-query';

/**
 * Create Lesson Modal Component
 * Form to create a new lesson with chapters
 */
function CreateLesson({ isOpen, onClose }) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      await createLesson.mutateAsync(formDataToSend);
