...
import {
  useStudentLessonById,
  useMarkChapterAsSeen,
        ...
        <div className="max-w-4xl mx-auto px-4 py-8">
          <div className="bg-white/80 backdrop-blur-sm rounded-[3rem] shadow-2xl p-12 text-center border-4 border-dashed border-indigo-200">
            ...
            <p className="text-lg text-indigo-600 font-semibold mb-8">
              This lesson doesn't exist or has no chapters yet.
            </p>
            <button
        ...
        <div className="bg-gradient-to-r from-[#F4C21A] to-[#FFD700] rounded-3xl shadow-2xl p-8 mb-8">
          <div className="flex items-start gap-6">
            {lesson.imageUrl ? (
              ...
              <div
                className={`w-32 h-32 ${getCategoryColor(lesson.category)} rounded-2xl flex items-center justify-center text-6xl shadow-lg`}
              >
